...
// ================================================================================= //
//
// Image Processor.jsx 2.05.1
// Version: 2.05.1
// Date: 09/03/2023
// Description: New Image Processor based with the Image Processor.jsx 1.2.0.1 added the PNG type file to save
...
function GlobalVariables() {
	...
	strSaveAsPNG = localize("$$$/JavaScript/ImageProcessor/SaveAsPNG=Save as &PNG");
	...
	strPNGQuality = localize( "$$$/JavaScripts/ImageProcessor/PNGQuality=PNG Quality must be between 0 and 2." );
...
function ImageProcessor() {
	...
	this.CreateDialog = function() {
		...
		d.etResizePNGW = p.grpPNG.grpRight.grpW.add( 'editnumber', undefined, undefined, 1, gMaxResize);
		...
		d.etResizePNGH = p.grpPNG.grpRight.grpH.add( 'editnumber', undefined, undefined, 1, gMaxResize);
	...
	this.InitDialog = function() {
		...
		d.etResizePNGH.value = p["pngh"];
		d.etResizePNGW.value = p["pngw"];
	...
	this.GetParamsFromDialog = function() {
		...
		p["pngh"] = d.etResizePNGH.value;
		p["pngw"] = d.etResizePNGW.value;
		...
		this.dlgMain.btnRun.onClick = function () {
			...
			if ( d.cbPNG.value ){
				if ( d.cbResizePNG.value ) {
					var w = d.etResizePNGW.value;
					var h = d.etResizePNGH.value;
	...
	// I can save in three formats, PNG, JPEG, PSD, TIFF
